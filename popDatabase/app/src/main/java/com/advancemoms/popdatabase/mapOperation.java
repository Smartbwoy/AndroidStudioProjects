...
public class mapOperation extends AppCompatActivity implements LocationListener
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == REQUEST_LOCATION) {
            if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(mapOperation.this, "permission granted", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(mapOperation.this, "Permission denied", Toast.LENGTH_LONG).show();
            }
        }
    }
}